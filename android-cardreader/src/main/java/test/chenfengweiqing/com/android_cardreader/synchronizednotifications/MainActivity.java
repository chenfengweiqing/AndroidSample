...
package test.chenfengweiqing.com.android_cardreader.synchronizednotifications;
...
import test.chenfengweiqing.com.android_cardreader.common.logger.LogWrapper;
import test.chenfengweiqing.com.android_cardreader.common.logger.MessageOnlyLogFilter;
...
public class MainActivity extends SampleActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.synchronizednotifications_activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.synchronizednotifications_main, menu);
        return true;
    }
