...
/**
 * A {@link WearableListenerService} that will be invoked when a
...
public class NotificationUpdateService extends WearableListenerService
    ...
    /**
     * Dismisses the phone notification, via a {@link PendingIntent} that is triggered
     * when the user dismisses the local notification. Deleting the corresponding data item notifies
     * the {@link WearableListenerService} on the phone that the
