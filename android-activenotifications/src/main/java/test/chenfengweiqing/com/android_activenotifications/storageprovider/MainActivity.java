...
package test.chenfengweiqing.com.android_activenotifications.storageprovider;
...
public class MainActivity extends SampleActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.storageprovider_activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.storageprovider_main, menu);
        return true;
    }
