...
package test.chenfengweiqing.com.android_activenotifications.swiperefreshlistfragment;
...
public class MainActivity extends SampleActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.swiperefreshlistfragment_activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.swiperefreshlistfragment_main, menu);
        return true;
    }
