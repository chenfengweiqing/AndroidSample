...
package test.chenfengweiqing.com.android_activenotifications.slidingtabsbasic;
...
public class MainActivity extends SampleActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slidingtabsbasic_activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.slidingtabsbasic_main, menu);
        return true;
    }
