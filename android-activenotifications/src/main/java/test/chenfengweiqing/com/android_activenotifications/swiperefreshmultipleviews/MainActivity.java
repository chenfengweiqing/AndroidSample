...
import test.chenfengweiqing.com.android_activenotifications.common.activities.SampleActivityBase;
...
public class MainActivity extends SampleActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.swiperefreshmultipleviews_activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.swiperefreshmultipleviews_main, menu);
        return true;
    }
