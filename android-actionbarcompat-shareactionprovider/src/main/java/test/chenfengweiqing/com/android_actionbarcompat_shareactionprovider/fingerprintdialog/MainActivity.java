...
package test.chenfengweiqing.com.android_actionbarcompat_shareactionprovider.fingerprintdialog;
...
import test.chenfengweiqing.com.android_actionbarcompat_shareactionprovider.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fingerprintdialog_activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.fingerprintdialog_menu_main, menu);
        return true;
    }
