...
import test.chenfengweiqing.com.android_autofillframework.view.autofillable.CreditCardExpirationDatePickerView;
...
public class CreditCardDatePickerActivity extends AppCompatActivity {
    ...
    public void showDatePickerDialog(View v) {
        if (v != mCcExpDateView) {
            Log.w(Util.TAG, "showDatePickerDialog() called on invalid view: " + v);
            return;
        }
